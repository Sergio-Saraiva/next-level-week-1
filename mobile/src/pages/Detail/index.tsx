...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.serializedPoint.whatsapp}&text=Tenho interesse na coleta de residuos`)
    }
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                <TouchableOpacity>
                    <Icon onPress={handleNavigateBack} name="arrow-left" size={20} color="#34cb79"/>
                </TouchableOpacity>

                <Image source={{uri: data.serializedPoint.image_url }} style={styles.pointImage} />
